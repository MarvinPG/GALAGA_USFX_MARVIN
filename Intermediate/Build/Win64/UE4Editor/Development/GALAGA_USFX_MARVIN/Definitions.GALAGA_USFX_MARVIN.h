...
#define UE_PROJECT_NAME GALAGA_USFX_MARVIN
#define UE_TARGET_NAME GALAGA_USFX_MARVINEditor
#define UE_MODULE_NAME "GALAGA_USFX_MARVIN"
...
#define GALAGA_USFX_MARVIN_API DLLEXPORT
